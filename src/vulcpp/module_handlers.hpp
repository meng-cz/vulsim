...
public:
    virtual ~VCPPModuleHandler() = default;
    virtual void run(VCPPModuleContext &context, const cppparse::MacroEntry &entry) = 0;
...
public:
    ...
    void run(VCPPModuleContext &context, const cppparse::MacroEntry &entry);
