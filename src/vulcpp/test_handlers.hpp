...
public:
    virtual ~VCPPTestHandler() = default;
    virtual void run(VCPPTestContext &context, const cppparse::MacroEntry &entry) = 0;
...
public:
    ...
    void run(VCPPTestContext &context, const cppparse::MacroEntry &entry);
